...
export default function TermsAndConditions(props) {
    return (
        <Card sx = {{ p: 5, height: '1000px', overflow: 'auto' }}  >
            {/* Aquí puedes colocar el contenido de tu componente Paper */}
            <Typography variant="h4" align = "center" sx={{ marginBottom: '1rem' }}>Términos y condiciones</Typography>
            ...
            <Typography variant="h6" align = "left" sx={{ marginTop: '1rem' }}>1. Información y Propósito </Typography>
            <Typography align = "justify">
            ...
            <Typography variant="h6" align = "left" sx={{ marginTop: '1rem' }}>2. Privacidad y Confidencialidad </Typography>
            <Typography align = "justify" sx={{ mb: 1}}>
                ...
                utilizamos y protegemos tu información personal. Te recomendamos leer nuestras políticas de 
                privacidad para comprender cómo manejamos tus datos.
            </Typography>
            <Typography variant="h8" align = "left" sx={{ fontStyle: 'italic'}}>2.1 Información recopilada </Typography>
            <Typography align = "justify" sx={{ mb: 1}}>
            ...
            <Typography variant="h8" align = "left" sx={{ fontStyle: 'italic'}}>2.2 Seguridad de la Información</Typography>
            <Typography align = "justify" sx={{ mb: 1}}>
            ...
            <Typography variant="h8" align = "left" sx={{ fontStyle: 'italic'}}>2.3 Mejora y Nuevos Estudios</Typography>
            <Typography align = "justify" sx={{ mb: 1}}>
            ...
            <Typography align = "left" sx={{ my: 1}}>
                Si no estás de acuerdo con alguno de estos términos y condiciones, te pedimos que no utilices nuestra aplicación.
            </Typography>
